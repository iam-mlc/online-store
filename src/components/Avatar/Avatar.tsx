...
const Avatar: React.FunctionComponent<IAvatarProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-2">
      <RadixAvatar.Root
        className={`inline-flex h-[${dimensions}px] w-[${dimensions}px] select-none items-center justify-center overflow-hidden rounded-full align-middle ${
          hasOutline
            ? `outline-4 outline-black/[.80] outline outline-offset-4`
            : ""
        }`}
      >
        <RadixAvatar.Image
